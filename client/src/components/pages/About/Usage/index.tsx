        ...
        <>
          ...
          {data.usage.byMonth && (
            <>
              ...
              <p>
                Confirmed users are users who create an account and confirm
                their email address.
              </p>
              <ColumnChart
              ...
              <p>
                Unconfirmed users are users who create an account but do not
                confirm their email address. They cannot use MoodTracker.
              </p>
              <ColumnChart
                data={Object.entries(data.usage.byMonth)
                  .map(([k, v]) => {
